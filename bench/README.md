...
during the 2026-04-21 cleanup — they referenced corpora and L3TC CLI
...
| `results/enwik6-phase2.*`, `results/enwik6-phase2-final.*` | L3TC-200K Rust runtime on enwik6 during Phase 2 |
| `results/enwik8-classical.*` | Classical compressors on 100 MB Wikipedia |
| `results/enwik8-l3tc.*` | L3TC-200K Rust runtime on enwik8 |
