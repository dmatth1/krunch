...
FORWARD_FILE=$(mktemp)
: > "$FORWARD_FILE"
for v in KRUNCH_BF16 KRUNCH_INT8_W8A8 KRUNCH_INT8_WEIGHTS KRUNCH_OWN_WKV KRUNCH_DETERMINISTIC_MATMUL KRUNCH_DECOMPRESS_BATCH KRUNCH_CHUNK_SIZE KRUNCH_TARGET_B KRUNCH_CPP_GRAPH; do
  if [[ -n "${!v:-}" ]]; then
